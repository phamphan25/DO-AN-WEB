                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('/binhluan')}}">
                                    <i class="fe fe-message-square" data-bs-toggle="tooltip"
                                        title="fe fe-message-square"></i>
                                    <span class="side-menu__label"> </span>
                                    <span class="side-menu__label">Bình luận</span><i class=""></i></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('/lienhe') }}">
                                    <i class="fe fe-phone" data-bs-toggle="tooltip" title="fe fe-phone"></i>
                                    <span class="side-menu__label"> </span>
                                    <span class="side-menu__label">Liên hệ</span><i class=""></i></a>
                            </li>
                            <li class="slide">
                                        ...
                                        <ul class="task-list">
                                            ...
                                            <li class="mb-2">
                                                ...
                                                <p class="text-muted mb-0 fs-12">Maggice bruce liked your article <a
                                                        href="#" class="fw-semibold ms-1"> Article on Projects</a></p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="unitedstates"
                                            src="../assets/images/flags/us_flag.jpg" class="me-2 language"></span>United
                                    States
                                </a>
                            </li>
                            <li class="col-lg-4 mb-2">
