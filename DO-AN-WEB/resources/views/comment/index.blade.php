                                                ...
                                                <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                                    <a class="dropdown-item d-flex p-4" href="cart.html">
                                                        ...
                                                        <div class="wp-60 cart-desc mt-1">
                                                            <p class="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">
                                                                TrueBasket Metal Single Pot
                                                            </p>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-auto">
                                                            <span
                                                                class="xm-title badge bg-secondary text-white fw-normal fs-11 badge-pill">
                                                                <a href="javascript:void(0);"
                                                                    class="showall-text text-white">Clear</a>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="message-menu ps2 overflow-hidden">
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            data-bs-image-src="../assets/images/users/1.jpg" style="
                                  background: url('../assets/images/users/1.jpg')
                                    center center;
                                "></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="../assets/images/users/15.jpg" style="
                                  background: url('../assets/images/users/15.jpg')
                                    center center;
                                ">
                                                        </span>
                                                        <div class="wd-90p">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="../assets/images/users/12.jpg" style="
                                  background: url('../assets/images/users/12.jpg')
                                    center center;
                                ">
                                                        </span>
                                                        <div class="wd-90p">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="../assets/images/users/4.jpg" style="
                                  background: url('../assets/images/users/4.jpg')
                                    center center;
                                ">
                                                        </span>
                                                        <div class="wd-90p">
                                            ...
                                            <a href="#" data-bs-toggle="dropdown"
                                                ...
                                                <div class="text-center p-1 d-flex d-lg-none-max">
                                                    <h6 class="mb-0" id="profile-heading">
                                                        Elena<i class="user-angle ms-1 fa fa-angle-down"></i>
                                                    </h6>
                                                </div>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li>
                                        <a href="form-layouts.html" class="slide-item">Form Layouts</a>
                                    </li>
                                    <li>
                                        <a href="form-validation.html" class="slide-item">Form Validation</a>
                                    </li>
                                    <li>
                                        <a href="form-advanced.html" class="slide-item">Form Advanced</a>
                                    </li>
                                    <li>
                                        <a href="wysiwyag.html" class="slide-item">Form Editors</a>
                                    </li>
                                    <li>
                                        <a href="form-editable.html" class="slide-item">Form editable</a>
                                    </li>
                                    <li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li>
                                        <a href="table-editable.html" class="slide-item">Editable Tables</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="landing.html"
                                    target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"
                                        enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                        <path
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li>
                                        <a href="chart-chartjs.html" class="slide-item">Chart Js</a>
                                    </li>
                                    <li>
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="#">Submenu-2.1</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="#">Submenu-2.2</a>
                                            </li>
                                            <li class="sub-slide2">
                                                ...
                                                <ul class="sub-slide-menu2">
                                                    <li>
                                                        <a href="#" class="sub-slide-item2">Submenu-2.3.1</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" class="sub-slide-item2">Submenu-2.3.2</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" class="sub-slide-item2">Submenu-2.3.3</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="#">Submenu-2.4</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="#">Submenu-2.5</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li>
                                        <a href="calendar2.html" class="slide-item">Calendar</a>
                                    </li>
                                    ...
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="cart.html">Cart</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="checkout.html">Checkout</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="products.html">Products</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a class="sub-slide-item" href="wishlist.html">Wishlist</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="file-manager.html">Files</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="file-manager-1.html">File Manager</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="file-manager-2.html">File Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="mail-inbox.html">Inbox</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="mail-compose.html">Compose Mail</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="mail-read.html">Read Mail</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="mail-settings.html">Mail Settings</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="invoice-list.html">Invoice List</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="invoice-details.html">Invoice
                                                    Details</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="invoice-create.html">Create Invoice</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="invoice-timelog.html">Time Log
                                                    Invoice</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="invoice-edit.html">Edit Invoice</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="projects.html">Projects</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="projects-list.html">Projects List</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="project-details.html">Project
                                                    Details</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="project-new.html">Project New</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="project-edit.html">Edit Project</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="ticket-details.html" class="slide-item"><span
                                    ...
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="tasks-list.html">Task List</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="task-edit.html">Edit Task</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="task-create.html">Create Task</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="clients.html">Clients</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="client-create.html">Add Client</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li>
                                        <a href="dropdown.html" class="slide-item">Dropdown</a>
                                    </li>
                                    <li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li>
                                        <a href="progress.html" class="slide-item">Progress Bars</a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="users-list.html" class="slide-item">Users List</a>
                                    </li>
                                    <li>
                                        <a href="file-attachments.html" class="slide-item">File Attachments</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="login.html">Sign In</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="register.html">Sign Up</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="forgot-password.html">Forgot
                                                    Password</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="lockscreen.html">Lockscreen</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="construction.html">UnderConstruction</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="404.html">404 Error</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="500.html">500 Error</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="501.html">501 Error</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="settings.html" class="slide-item">Settings</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="switcher.html" class="slide-item">Switcher</a>
                                    </li>
                                    <li><a href="terms.html" class="slide-item">Terms</a></li>
                                    <li><a href="faq.html" class="slide-item">Faq's</a></li>
                                    <li>
                                        <a href="pricing.html" class="slide-item">Pricing</a>
                                    </li>
                                    <li class="sub-slide">
                                        <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                                        ...
                                        <ul class="sub-slide-menu">
                                            <li>
                                                <a class="sub-slide-item" href="blog.html">Blog</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="blog-details.html">Blog Details</a>
                                            </li>
                                            <li>
                                                <a class="sub-slide-item" href="blog-edit.html">Edit Post</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li>
                                        <a href="background.html" class="slide-item">Background</a>
                                    </li>
                                    <li><a href="border.html" class="slide-item">Border</a></li>
                                    <li>
                                        <a href="display.html" class="slide-item">Display</a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="padding.html" class="slide-item">Padding</a>
                                    </li>
                                    <li>
                                        <a href="position.html" class="slide-item">Position</a>
                                    </li>
                                    <li><a href="width.html" class="slide-item">Width</a></li>
                                    <li>
                                        <a href="opacity.html" class="slide-item">Opacity</a>
                                    </li>
                                    <li>
                            ...
                            <div class="col-lg-12">
                                <div class="card custom-card">
                                    <div class="card-header border-bottom">
                                        ...
                                        <!-- Đổi tên bảng thành Comment Table -->
                                    </div>
                                    <div class="card-body">
                                        <p class="text-muted">
                                            Displaying user comments on the product.
                                        </p>
                                            ...
                                            <table class="table border text-nowrap text-md-nowrap">
                                                ...
                                                <body>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $comment->conyent }}</td>
                                                        <td>{{ $comment->Evaluate }}</td>
                    ...
                    <div class="container">
                        <div class="row align-items-center flex-row-reverse">
                            <div class="col-md-12 col-sm-12 text-center">
                                Copyright © 2022 <a href="#">Noa</a>. Designed with
